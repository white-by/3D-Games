...
public class UserGUI : MonoBehaviour
{
    ...
    void mainMenu() {
        GUI.Label(new Rect(Screen.width / 2 - menu_width * 0.5f, Screen.height * 0.1f, menu_width, menu_height), "Hit UFO\n鼠标打飞碟", bigStyle);
    ...
    void GameStart() {
        GUI.Label(new Rect(450, 60, 50, 200), gameMessage, bigStyle);
        GUI.Label(new Rect(50,20,100,50), "得分: " + score, smallStyle);
        GUI.Label(new Rect(800,20,100,50), "轮次: " + round, smallStyle);
    }
}
